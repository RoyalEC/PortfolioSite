...
function Home() {
  return (
    <div className="bg-gray-100 dark:bg-gray-800 text-black dark:text-white shadow p-4">
      ...
      <h1 className="text-5xl font-extrabold text-gray-900 dark:text-white mb-6 border-b-4 border-blue-500 mx-auto w-fit">
        Portfolio
      </h1>
      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-gray-600 dark:text-gray-300">Software Developer • WGU Graduate • Technically Versatile</p>
        ...
        <div className="flex justify-center space-x-4 mt-4">
          ...
          <a href="https://github.com/RoyalEC" target="_blank">
            <button className="bg-gray-800 dark:bg-white text-white dark:text-gray-800 px-4 py-2 rounded">GitHub</button>
          </a>
        ...
        <div className="space-y-6 text-left">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Jun 2024 – Present</p>
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Mar 2020 – Mar 2025</p>
            <ul className="list-disc list-inside mt-2 text-gray-700 dark:text-gray-300 space-y-1">
        ...
        <div className="mt-10 text-left">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Azure */}
            <div className="flex items-start gap-4 bg-white dark:bg-gray-700 p-4 shadow rounded">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">Issued by Microsoft</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-white dark:bg-gray-700 p-4 shadow rounded">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">Issued by Amazon Web Services</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-white dark:bg-gray-700 p-4 shadow rounded">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">Issued by AXELOS</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-white dark:bg-gray-700 p-4 shadow rounded">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">Issued by Western Governors University</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-white dark:bg-gray-700 p-4 shadow rounded">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">Issued by Linux Professional Institute</p>
              </div>
            </div>
